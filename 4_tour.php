...
<head>
	...
	<title>Group Tours - Melt Your Vacation</title>
</head>
<body>
        ...
        <div class="sl">
            <div class="sl__slide">
                <img src="img/trips/group1.jpg" alt ="slider image"
                class="rounded mx-auto d-block" width="450" height="270">
            </div>
            <div class="sl__slide">
                <img src="img/trips/group2.jpg" alt ="slider image"
                class="rounded mx-auto d-block" width="450" height="270">
            </div>
            <div class="sl__slide">
                <img src="img/trips/group3.jpg" alt ="slider image"
                class="rounded mx-auto d-block" width="450" height="270">
            </div>
            <div class="sl__slide">
                <img src="img/trips/group4.jpg" alt ="slider image"
                class="rounded mx-auto d-block" width="450" height="270">
            </div>
        </div>
        ...
        <?php
                 ...
                 $query = 'SELECT T_name, T_price, T_desc FROM trip where T_category_id_fk="4"';
        ...
        <h3 class = "mb-3" >Select your trip:</h3><br><br>

<?php
//Checking for empty columns in the table
if(mysqli_num_rows($result)== 0){
echo "Sorry, there are no trip available"; }
else
