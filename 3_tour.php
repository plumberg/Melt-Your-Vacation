...
<body>
        ...
        <div class="sl">
            <div class="sl__slide">
                <img src="img/trips/cruise1.jpg" alt ="slider image"
                class="rounded mx-auto d-block" width="450" height="270">
            </div>
            <div class="sl__slide">
                <img src="img/trips/cruise2.jpg" alt ="slider image"
                class="rounded mx-auto d-block" width="450" height="270">
            </div>
            <div class="sl__slide">
                <img src="img/trips/cruise3.jpg" alt ="slider image"
                class="rounded mx-auto d-block" width="450" height="270">
            </div>
            <div class="sl__slide">
                <img src="img/trips/cruise4.jpg" alt ="slider image"
                class="rounded mx-auto d-block" width="450" height="270">
            </div>
        </div>
        ...
        <?php
                 ...
                 $query = 'SELECT T_name, T_price, T_desc FROM trip where T_category_id_fk="3"';
